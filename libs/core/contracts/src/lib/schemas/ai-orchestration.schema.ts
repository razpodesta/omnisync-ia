 ...
 */
export const ArtificialIntelligenceModelConfigurationSchema = z
  .object({
 ...
 */
export type IArtificialIntelligenceModelConfiguration = z.infer<
  typeof ArtificialIntelligenceModelConfigurationSchema
>;
