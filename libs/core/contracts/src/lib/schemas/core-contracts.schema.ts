 ...
 */
export const OmnisyncUserSchema = z.object({
  id: UserIdSchema,
 ...
 */
export const AIResolutionStatusSchema = z.enum(['RESOLVED', 'NEED_HUMAN', 'NEED_MORE_INFO', 'ESCALATED_TO_ERP']);
 ...
 */
export const ERPTaskPrioritySchema = z.enum(['LOW', 'MEDIUM', 'HIGH', 'URGENT']);

export const ERPTicketSchema = z.object({
