 ...
 */
export const NeuralBridgeConfigurationSchema = z.object({
  /** URL absoluta del backend en Render/Cloud */
  baseUrl: z.string().url({ message: 'OS-CORE-503: La URL del Hub no es válida.' }),
...
export type INeuralBridgeConfiguration = z.infer<typeof NeuralBridgeConfigurationSchema>;
