...
export type IKnowledgeSourceDocument = z.infer<
  typeof KnowledgeSourceDocumentSchema
>;
 ...
 */
export const KnowledgeSemanticChunkSchema = z
  .object({
...
export type IKnowledgeSemanticChunk = z.infer<
  typeof KnowledgeSemanticChunkSchema
>;
 ...
 */
export const KnowledgeSemanticSearchResultSchema = z
  .object({
...
export type IKnowledgeSemanticSearchResult = z.infer<
  typeof KnowledgeSemanticSearchResultSchema
>;
