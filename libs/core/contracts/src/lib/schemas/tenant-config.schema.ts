 ...
 */
export const OperationalStatusSchema = z.enum(['ACTIVE', 'SUSPENDED', 'MAINTENANCE', 'PROVISIONING']);
...
export const TenantConfigurationSchema = z.object({
  ...
  artificialIntelligence: z.object({
    provider: z.enum(['GOOGLE_GEMINI', 'OPENAI_GPT', 'ANTHROPIC_CLAUDE', 'LOCAL_LLAMA']),
  ...
  enterpriseResourcePlanning: z.object({
    adapterIdentifier: z.enum(['MOCK_SYSTEM', 'ODOO_V16', 'SAP_BUSINESS_ONE', 'SALESFORCE_CRM']),
