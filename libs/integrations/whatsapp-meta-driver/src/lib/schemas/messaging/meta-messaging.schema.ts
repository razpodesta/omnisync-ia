...
import { z } from 'zod';
import { MetaInteractiveButtonSchema, MetaInteractiveListSectionSchema } from '../meta-contracts.schema';
...
export const MetaOutboundPayloadSchema = z.object({
  ...
  messageType: z.enum(['text', 'audio', 'image', 'video', 'document', 'interactive', 'template']),
