 ...
 */
export const MetaMessageStatusSchema = z.enum([
  'delivered',
  'read',
  'sent',
  'failed',
 ...
 */
export const MetaPresenceActionSchema = z
  .object({
    recipientPhoneNumber: z
      .string()
      .regex(/^\d{10,15}$/, 'Formato internacional E.164 requerido.'),
 ...
 */
export const MetaMediaObjectSchema = z
  .object({
    id: z.string().min(1),
    mimeType: z.string(),
...
export const MetaInteractiveButtonSchema = z
  .object({
...
export const MetaInteractiveListSectionSchema = z
  .object({
    title: z.string().max(20),
    rows: z.array(
      z.object({
...
export const MetaVoiceCallSignalSchema = z
  .object({
...
export const MetaWebhookMessageSchema = z
  .object({
    from: z.string(),
    id: z.string(),
    timestamp: z.string(),
            ...
            value: z.object({
              ...
              statuses: z
                .array(
                  z.object({
                    id: z.string(),
                    status: MetaMessageStatusSchema,
                    timestamp: z.string(),
                  }),
                )
                .optional(),
