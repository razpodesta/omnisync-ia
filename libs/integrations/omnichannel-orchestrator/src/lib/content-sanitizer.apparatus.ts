...
export class ContentSanitizerApparatus {
  ...
  public static executeSovereignSanitization(
    ...
    return OmnisyncTelemetry.traceExecutionSync(apparatusName, operationName, () => {
      ...
      const configuration = ContentSanitizationConfigurationSchema.parse(customConfiguration);
      ...
      return sanitizedBuffer.substring(0, configuration.maximumCharacterLength);
    });
  }
