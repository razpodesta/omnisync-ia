 ...
 */
export const ContentSanitizationConfigurationSchema = z.object({
...
export type IContentSanitizationConfiguration = z.infer<typeof ContentSanitizationConfigurationSchema>;