 ...
 */
export const NeuralDialogueMessageSchema = z
  .object({
...
export type INeuralDialogueMessage = z.infer<
  typeof NeuralDialogueMessageSchema
>;
 ...
 */
export const NeuralPromptContextSchema = z
  .object({
